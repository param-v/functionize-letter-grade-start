...
function btnClicked() {
  ...
  document.getElementById("eng-letter").innerHTML = check(engPercent);
  document.getElementById("soc-letter").innerHTML = check(socPercent);
  document.getElementById("math-letter").innerHTML = check(mathPercent);
  document.getElementById("sci-letter").innerHTML = check(sciPercent);
}
